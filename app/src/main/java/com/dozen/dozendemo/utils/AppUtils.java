package com.dozen.dozendemo.utils;
...
import com.dozen.dozendemo.utils.bean.AppProcessInfo;
import com.dozen.dozendemo.utils.bean.ProcessInfo;
        ...
        method.invoke(context.getPackageManager(), pkgName,
                new IPackageStatsObserver.Stub() {
                    ...
                    public void onGetStatsCompleted(PackageStats pStats, boolean succeeded) throws RemoteException {
                        ...
                        pkgSize[0] = pStats.cacheSize + pStats.dataSize + pStats.codeSize;
